...
<%
	if("1".equals(errorId)){
%>
	  <input name="back" type="button" id="back" value="关闭" class="flyBT" onclick="closePage()">
<%		
	}else{
%>
	   <input name="back" type="button" id="back" value="返回上一页" class="flyBT" onclick="window.history.back()">
<%
	}
%>
</td>
