...
Ext.extend(Ext.ux.grid.GridHeaderFilters, Ext.util.Observable, 
{
    ...
    { 
    	try{
    		eval("this._showHeader=_"+this._tableId+"_showHeader;");
    	}catch(e){
    		return;
    	}
        ...
        if(this._showHeader){
        	eval("_"+this._tableId+"_showHeader=false;");
        	this.grid.fireEvent("filterupdate",el.filterName,sValue,el,this.filters);
        }
        
        //console.log("xxx="+el.filterName+","+sValue+","+el+","+this.filters);
        //new start
//        if(el.value)
       ...
       // var qryWhere = '';
        //for(var i in this.filters) {
        	...
        	//	filters.push({property:i,value:this.filters[i]});
       // }
