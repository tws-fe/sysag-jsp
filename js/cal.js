...
function doLoadCalendar()
{
	...
	for ( i = 0; i < oInputs.length; i++ )
	{
		...
		{
			oInputs(i).insertAdjacentHTML("afterEnd", "<input type=button id=\"date_"+oInputs(i).uniqueID+"\" value=\"选择\" class=\"flyBT\" style=\"height=22\" onclick=\"return showCalendar('"+oInputs(i).uniqueID+"', 'y-mm-dd');\">");  
