...
keel.UploadPanel = function(cfg){
	...
	keel.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			{text:'添加文件',icon:MATECH_SYSTEM_WEB_ROOT+'/share/img/add.png',iconCls:'add',ref:'../addBtn'},'-',
			{text:'上传',icon:MATECH_SYSTEM_WEB_ROOT+'/share/img/save.png',ref:'../uploadBtn',iconCls:'up',handler:this.startUpload,scope:this},'-',
			{text:'停止上传',icon:MATECH_SYSTEM_WEB_ROOT+'/share/img/delete.png',ref:'../stopBtn',iconCls:'delete',handler:this.stopUpload,scope:this,disabled:true},'-',
			{text:'删除所有',icon:MATECH_SYSTEM_WEB_ROOT+'/share/img/delete.png',ref:'../deleteBtn',iconCls:'delete2',handler:this.deleteAll,scope:this},'-'
		],
