...
function getJsonData(){
	...
	var sql1=" SELECT DISTINCT a.uuid AS VALUE,CONCAT(a.casename,'-',a.casenumber) AS NAME FROM ga_case a  INNER JOIN ga_suspect s ON (a.`casenumber`=s.`mainformid`) WHERE a.organid_='"+ctlUnitId+"'  ORDER BY casenumber DESC";
