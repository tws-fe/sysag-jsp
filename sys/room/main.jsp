...
function extInit(){
	...
	var center = new Ext.Panel({
		...
		border:true,
		margins:'0 0 0 0',
		html:'<iframe name="listframe" id="listframe" scrolling="no" frameborder="0" width="100%" height="100%" src="${ctx}/room.do?method=list&unitId=${unitId}"></iframe>'
	});
...
function treeClick(node){
	...
	doc.dom.src = "${pageContext.request.contextPath}/room.do?method=list&unitId="+node.id+"&rand="+Math.random();
}
