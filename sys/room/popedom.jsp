...
<form name="thisForm" method="post" action="" id="thisForm" >
	...
	<input name="uuid" type="text" id="roleId" value="${uuid}" >
...
function ext_init() {
	...
	var popedemTreeLoader = new Tree.TreeLoader({
        dataUrl:'${pageContext.request.contextPath}/room.do?method=popedom&uuid=${uuid}'
    });
    ...
    tree_right = new Tree.TreePanel({
     ...
     var treeTbar = new Ext.Toolbar({
 		items:[{ 
 			...
 			handler:function(){
 				...
 				/* if("${sessionScope.userSession.userLoginId}" !="admin"){
 				 ...
 				 document.thisForm.action="${pageContext.request.contextPath}/room.do?method=popedomSave";	
 		...
 		},'-','<div style="margin-left:50px;color:#ff6600;">房间名称：${roomBH}</div>'
