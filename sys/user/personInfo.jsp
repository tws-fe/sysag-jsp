	...
	<form name="thisForm" id="thisForm" method="post" action="${ctx}/userNew.do?method=save" class="autoHeightExtForm">
		<table border="0" cellspacing="0" class="editTable">
			...
			<tr>
				...
				<td >
				  <input class="required" autoid="js:sys.dept.DeptByUnitId" listWidth="600" id="departmentid" name="departmentid" size="50" value="${user.departmentid}" multilevel=true listWidth="320" loadAll="false" refer="departid" readOnly/>
				</td>
			</tr>
			<tr>
				<th>指纹采集：</th>
			...
			<tr>
				...
				<td >
				  <input autoid="js:sys.user.UserStateImpl" id="state" name="state" size="50" value="${user.state}" listWidth="320" readOnly/>
				</td>
			</tr>	
...
function save(){
	...
	matech.formSummit('thisForm',"${ctx}/userNew.do?method=personEdit");
