...
<div id="tab1">
	<form name="thisForm" id="thisForm" method="post" action="${ctx}/sysScript.do?method=saveFile" class="autoHeightExtForm">
		<table border="0" cellspacing="0" class="editTable">
			...
			<tr>
				...
				<td>
				   <input type="hidden" name="attachId" id="attachId" value="${param.id}" ext_type="attachFile" ext_filetype="js"
		...
		<input name="path" id="path" type="hidden" value="${param.path}">
		<input name="scriptId" id="scriptId" type="hidden" value="${param.scriptId}">
...
function save(){
	matech.formSummit('thisForm',"${ctx}/sysScript.do?method=list&scriptId=${param.scriptId}",function(){
