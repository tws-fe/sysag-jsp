...
Ext.onReady(function(){
	 ...
	 _grid= new Ext.matech.grid.GridPanel({
			id:"gridId_allCaseList",
			autoid:"js:gbag.casese.FinishCaseGridJson",
...
function _restoreSelectCheck(store,records){
	...
	store.each(function(r){
		...
		if(remindersum>=3){
			Ext.getCmp('gridId_allCaseList').getView().getRow(girdcount).style.backgroundColor='red';
		}else if(remindersum>="1"&&remindersum<"3"){
			Ext.getCmp('gridId_allCaseList').getView().getRow(girdcount).style.backgroundColor='orange';
		}
