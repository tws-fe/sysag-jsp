...
function ext_init(){
	...
	var tbar = new Ext.Toolbar({	   		
		...
		items:[{
			...
			handler:function(){
					var url = MATECH_SYSTEM_WEB_ROOT + "/police.do?method=archiveItemsXSList&savestyle=XS";								
				window.location = url;	
			}  
		}]
	});
...
<table  cellpadding="8" cellspacing="0" style='width:100%' align="center" class="data_tb" >
    ...
    <tr>
		...
		<td class="data_tb_content" >
				<input type="text" id="casetype"  name="casetype"  class="required"  value="刑事案件" readOnly/>	
		</td>
