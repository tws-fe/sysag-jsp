...
Ext.onReady(function(){
	 ...
	 _grid= new Ext.matech.grid.GridPanel({
			id:"gridId_caseUnSummitList",
			autoid:"js:gbag.casevisit.CaseMyVisitListGridJson",
			param:{flag:"${flag}"},		
			currentPage:1,
			singleSelect:true,
			columns:[
					{id:"UUID",header:"UUID",dataIndex:"UUID",width:150,sortable:true,align:"left",hidden:true},
			        {id:"RESULT",header:"处理结果",dataIndex:"RESULT",width:80,sortable:true,align:"left"},
			...
			fields:["UUID","RESULT","VISITTIME","NAME","TELNUM","VISITFOR","RECEIVEREPLY","REPLY","VISITNUMS","CASENUMBER","CASETYPE","CASENATURENAME","CASENAME","STATENAMES","AUDITDIRECTORNAME","ISSIGNNAME","ISHANDOVERNAME","BJSJ",
...
function edit() {
	...
	var url = MATECH_SYSTEM_WEB_ROOT + "/caseVist.do?method=caseVisitEdit&editType=update&pKey=1&uuid=" + value;
