...
<div class="div_one">
	<div class="div_two">
		...
		<div class="circle">
			<a id="eventrecord3" ></a>
			<p class="dayterm">已交案件</p>
		</div>
		<div class="circle">
			<a  id="eventrecord4" style="color:red ;"  ></a>
			<p class="dayterm">超期未交</p>
		</div>
	</div>
...
function guaranteeinit(){
	$.post("${pageContext.request.contextPath}/view.do?method=samemonthmassesishandover",function(data){
		jsonobj = eval("["+data+"]") ;
