        ...
        if(!this.list){
            ...
            var combo = this ;
	  		...
	  		this.tbar = new Ext.Toolbar({
		           items:[{
					text:'清空',
			   		icon:TEMP_SYSTEM_WEB_ROOT+'/tws/css/img/delete.gif',
			   		 handler:function(){
			   			combo.clear();
			   		 }
				},'-'
	  		...
	  		if(this.multilevel){				
				this.tbar.add([{text:'',icon:TEMP_SYSTEM_WEB_ROOT+'/tws/css/img/tree/treeAllExpand.png',handler:function(){combo.treeNodeExpandOrCollap(0);}},
				               '-',
				               {text:'',icon:TEMP_SYSTEM_WEB_ROOT+'/tws/css/img/tree/treeAllCollaps.png',handler:function(){combo.treeNodeExpandOrCollap(1);}}
				               ]);
				...
				this.tbar.add([{text:'',icon:TEMP_SYSTEM_WEB_ROOT+'/tws/css/img/tree/treeSearch.gif',handler:function(){combo.treeNodeSearch(Ext.getCmp(_inputId).getValue());}}]);
